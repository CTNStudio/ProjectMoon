...
public class PlayerAnimEvents {
    ...
    public static void empty(PlayerInteractEvent.LeftClickEmpty event) {
        if (!(getItem(event.getEntity()) instanceof PlayerAnim item) || !item.isLeftKeyEmpty()) {
            return;
        }
    ...
    public static void block(PlayerInteractEvent.LeftClickBlock event) {
        if (!(getItem(event.getEntity()) instanceof PlayerAnim item) || !item.isLeftKeyBlock()) {
            return;
        }
    ...
    public static void entity(AttackEntityEvent event) {
        if (!(getItem(event.getEntity()) instanceof PlayerAnim item) || !item.isLeftKeyEntity()) {
            return;
        }
    ...
    public static void empty(PlayerInteractEvent.RightClickEmpty event) {
        if (!(getItem(event.getEntity()) instanceof PlayerAnim item) || !item.isRightKeyEmpty()) {
            return;
        }
    ...
    public static void block(PlayerInteractEvent.RightClickBlock event) {
        if (!(getItem(event.getEntity()) instanceof PlayerAnim item) || !item.isRightKeyBlock()) {
            return;
        }
    ...
    public static void entity(PlayerInteractEvent.EntityInteract event) {
        if (!(getItem(event.getEntity()) instanceof PlayerAnim item) || !item.isRightKeyEntity()) {
            return;
        }
