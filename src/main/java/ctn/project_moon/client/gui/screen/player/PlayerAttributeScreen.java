...
public class PlayerAttributeScreen extends EffectRenderingInventoryScreen<PlayerAttributeMenu> implements ICuriosScreen {
	...
	public static final ResourceLocation[] ATTRIBUTE_LV    = {
			getSpritePath("attribute_lv1"),
			getSpritePath("attribute_lv2"),
			getSpritePath("attribute_lv3"),
			getSpritePath("attribute_lv4"),
			getSpritePath("attribute_lv5"),
			getSpritePath("attribute_lv_ex")
	};
	...
	public static final ResourceLocation[] RESISTANCE_LV   = {
			getSpritePath("resistance_immunity"),
			getSpritePath("resistance_very_tall"),
			getSpritePath("resistance_tall"),
			getSpritePath("resistance_ordinary"),
			getSpritePath("resistance_low"),
			getSpritePath("resistance_very_low")
	};
	public static final ResourceLocation[] ATTRIBUTE       = {
			getSpritePath("fortitude"),
			getSpritePath("prudence"),
			getSpritePath("temperance"),
			getSpritePath("justice")
	};
	public static final ResourceLocation[] RESISTANCE      = {
			getSpritePath("resistance_physics"),
			getSpritePath("resistance_rationality"),
			getSpritePath("resistance_erosion"),
			getSpritePath("resistance_the_soul")
	};
	public static final ResourceLocation   SCROLLBAR       = getSpritePath("scrollbar");
	public static final ResourceLocation   SCROLLBAR_PRESS = getSpritePath("scrollbar_press");
	...
	private static @NotNull ResourceLocation getSpritePath(String path) {
		return getPath("player_attribute/" + path);
	}
