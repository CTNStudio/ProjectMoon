...
public class DatagenI18ZhCn extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		addAttribute(PmEntityAttributes.SPIRIT_RESISTANCE, "受精神伤害倍率");
		addAttribute(PmEntityAttributes.EROSION_RESISTANCE, "受侵蚀伤害倍率");
		addAttribute(PmEntityAttributes.THE_SOUL_RESISTANCE, "受灵魂伤害倍率");
		addAttribute(PmEntityAttributes.MAX_FORTITUDE, "勇气最大点数");
		addAttribute(PmEntityAttributes.MAX_PRUDENCE, "谨慎最大点数");
		addAttribute(PmEntityAttributes.MAX_RATIONALITY, "最大理智值");
		addAttribute(PmEntityAttributes.MAX_TEMPERANCE, "自律最大点数");
		addAttribute(PmEntityAttributes.FORTITUDE_ADDITIONAL, "附加勇气");
		addAttribute(PmEntityAttributes.PRUDENCE_ADDITIONAL, "附加谨慎");
		addAttribute(PmEntityAttributes.TEMPERANCE_ADDITIONAL, "附加自律");
		addAttribute(PmEntityAttributes.JUSTICE_ADDITIONAL, "附加正义");
		addAttribute(PmEntityAttributes.MAX_JUSTICE, "正义最大点数");
		addAttribute(PmEntityAttributes.COMPOSITE_RATING, "综合评级");
		...
		addAttribute(PmItemDataComponents.IS_RESTRAIN, "抑制器影响");
		addAttribute(PmItemDataComponents.COLOR_DAMAGE_TYPE, "伤害类型");
		...
		addConfig("enable_natural_rationality_rationality", "自然恢复理智值", "生物是否可以自然恢复理智值");
		...
		addSkill(PmSkills.MAGIC_BULLET_SILENCING, "魔弹-噤声");
		addSkill(PmSkills.MAGIC_BULLET_PENETRATING, "魔弹-贯穿");
		addSkill(PmSkills.MAGIC_BULLET_FLOODED, "魔弹-倾泻");
	}
	...
	public void addSkill(Holder<Skill> skillHolder, String name) {
		add(skillHolder.value(), name);
	}
	
	public void add(Skill skill, String name) {
		add("skills." + skill.getSkillId().toString(), name);
	}
}
