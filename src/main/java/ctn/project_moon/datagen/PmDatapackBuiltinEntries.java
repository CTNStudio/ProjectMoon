...
public class PmDatapackBuiltinEntries extends DatapackBuiltinEntriesProvider {
    ...
    public PmDatapackBuiltinEntries(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
