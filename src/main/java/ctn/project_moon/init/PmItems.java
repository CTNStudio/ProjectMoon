...
import ctn.project_moon.common.item.CreativeRationalityToolItem;
...
public class PmItems {
	...
	public static final DeferredItem<Item> CREATIVE_RATIONALITY_TOOL = creativeToolItem("creative_rationality_tool", CreativeRationalityToolItem::new);
