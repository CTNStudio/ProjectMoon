...
public class PmParticleTypes {
	...
	public static final Supplier<ParticleType<DamageParticle.Options>> DAMAGE_PARTICLE_TYPE =
			register("damage_particle_type", false, DamageParticle.Options.CODEC, DamageParticle.Options.STREAM_CODEC);
