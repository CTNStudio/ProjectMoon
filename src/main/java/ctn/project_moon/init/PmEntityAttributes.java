...
public class PmEntityAttributes {
	...
	/** 精神伤害抵抗能力 */
	public static final Holder<Attribute>           SPIRIT_RESISTANCE                 = registerRangedAttribute("generic.rationality_resistance", "attribute.name.generic.rationality_resistance", 1.0, -1024, 1024);
	/** 侵蚀伤害抵抗能力 */
	...
	/** 理智值自然恢复效率 */
	public static final Holder<Attribute>           RATIONALITY_NATURAL_RECOVERY_RATE = registerRangedAttribute("generic.rationality_natural_recovery_rate", "attribute.name.generic.rationality_natural_recovery_rate", 0.5, 0, 4096);
	/** 理智值自然恢复量 */
	public static final Holder<Attribute>           RATIONALITY_RECOVERY_AMOUNT       = registerRangedAttribute("generic.rationality_recovery_amount", "attribute.name.generic.rationality_recovery_amount", 1, 0, 4096);
	...
	/** 四色属性附加值(用于饰品加成等) */
	public static final Holder<Attribute> FORTITUDE_ADDITIONAL  = registerRangedAttribute("player.fortitude_additional", "attribute.name.player.fortitude_additional", 0, -4096, 4096);
	public static final Holder<Attribute> PRUDENCE_ADDITIONAL   = registerRangedAttribute("player.prudence_additional", "attribute.name.player.prudence_additional", 0, -4096, 4096);
	public static final Holder<Attribute> TEMPERANCE_ADDITIONAL = registerRangedAttribute("player.temperance_additional", "attribute.name.player.temperance_additional", 0, -4096, 4096);
	public static final Holder<Attribute> JUSTICE_ADDITIONAL    = registerRangedAttribute("player.justice_additional", "attribute.name.player.justice_additional", 0, -4096, 4096);
